...
import { Home, Clock, ListChecks, MessageSquare, User, LogOut, HardHat } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/app/opgaver', label: 'Opgaver', icon: ListChecks },
  { to: '/app/beskeder', label: 'Beskeder', icon: MessageSquare },
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col max-w-md mx-auto shadow-xl relative">
      ...
      <main className="flex-1 overflow-y-auto pb-20">
        <Outlet context={{ user, syncClock, clockedIn }} />
      </main>
