...
export function safeReturnTo() {
  ...
  try {
    ...
    // Strip app-bootstrap params so a crafted returnTo cannot repoint the app
    // at another backend or inject an access token. Normal app-flow params
    // (e.g. the OAuth consent ctx) are kept.
